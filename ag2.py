...
from daku_memory_tools import remember_person, recall_person, list_known_people
from daku_navigation import navigate_to
...
class Assistant(Agent):
    def __init__(self, chat_ctx) -> None:
        super().__init__(chat_ctx = chat_ctx,
                        ...
                        llm=google.beta.realtime.RealtimeModel(voice="Leda",temperature=8.0,),
                        tools=[
                                google_search,
